        ...
        <div className="min-h-screen flex items-center justify-center bg-[#f7f8fd] px-4">
            ...
            <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-md">
                ...
                <form className="space-y-4">
                    ...
                    <Button
                        className="w-full bg-black text-white hover:bg-gray-800 active:bg-gray-900 transition-transform transform hover:scale-105 active:scale-95 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                        onClick={(e) => {
